...
build-grpc-bookstore:
	...
	@protoc -I tests/endpoints/bookstore_grpc/proto/v1 -I bazel-esp-v2/external/com_google_protobuf -I bazel-esp-v2/external/com_github_googleapis_googleapis \
	...
	@protoc -I tests/endpoints/bookstore_grpc/proto/v2 -I bazel-esp-v2/external/com_google_protobuf -I bazel-esp-v2/external/com_github_googleapis_googleapis \
