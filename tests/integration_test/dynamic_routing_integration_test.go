		...
		},
		{
			...
			wantScRequests: []interface{}{
				...
				&utils.ExpectedReport{
					...
					Platform:                     util.GCE,
					Location:                     "test-zone",
					ResponseCodeDetail:           "upstream_reset_before_response_started{connection failure,TLS error: 268435581:SSL routines:OPENSSL_internal:CERTIFICATE_VERIFY_FAILED}",
				},
			},
		},
	}
		...
		},
		{
			...
			wantScRequests: []interface{}{
				...
				&utils.ExpectedReport{
					...
					Platform:                     util.GCE,
					Location:                     "test-zone",
					ResponseCodeDetail:           "upstream_reset_before_response_started{connection failure,TLS error: 268436498:SSL routines:OPENSSL_internal:SSLV3_ALERT_BAD_CERTIFICATE}",
				},
			},
		},
	}
