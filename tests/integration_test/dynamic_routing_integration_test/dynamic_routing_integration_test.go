		...
		},
		{
			...
			wantScRequests: []interface{}{
				...
				&utils.ExpectedReport{
					...
					Platform:                     util.GCE,
					Location:                     "test-zone",
					ResponseCodeDetail:           "upstream_reset_before_response_started{connection_failure,TLS_error:_268436504:SSL_routines:OPENSSL_internal:TLSV1_ALERT_UNKNOWN_CA}",
				},
			},
		},
	}
