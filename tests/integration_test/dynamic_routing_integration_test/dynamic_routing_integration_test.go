...
package dynamic_routing_integration_test
		...
		},
		{
			...
			wantScRequests: []interface{}{
				...
				&utils.ExpectedReport{
					...
					Platform:                     util.GCE,
					Location:                     "test-zone",
					ResponseCodeDetail:           "upstream_reset_before_response_started{remote_connection_failure,TLS_error:_268435581:SSL_routines:OPENSSL_internal:CERTIFICATE_VERIFY_FAILED}",
				},
			},
		},
	}
