		...
		},
		{
			...
			wantScRequests: []interface{}{
				&utils.ExpectedReport{
					...
					ApiKeyInOperationAndLogEntry: "",
					ApiMethod:                    "1.echo_api_endpoints_cloudesf_testing_cloud_goog.CORS_bookstore_shelves_shelf",
					ApiName:                      "1.echo_api_endpoints_cloudesf_testing_cloud_goog",
					ProducerProjectID:            "producer-project",
					FrontendProtocol:             "http",
					HttpMethod:                   "OPTIONS",
					LogMessage:                   "1.echo_api_endpoints_cloudesf_testing_cloud_goog.CORS_bookstore_shelves_shelf is called",
					Referer:                      referer,
					StatusCode:                   "0",
					ResponseCode:                 204,
					Platform:                     util.GCE,
