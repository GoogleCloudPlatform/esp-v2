    ...
    def test_gen_proxy_config(self):
        testcases = [
            ...
            (['--service=test_bookstore.gloud.run', '--version=2019-11-09r0',
             ...
             ['bin/configmanager', '--logtostderr', '--backend', 'grpc://127.0.0.1:8000',
            ...
            (['-R=managed',
              ...
              '--disable_tracing'],
             ['bin/configmanager', '--logtostderr','--backend', 'http://127.0.0.1:8082',
            ...
            (['--service=test_bookstore.gloud.run',
              ...
              '--service_account_key', '/tmp/service_accout_key',
              '--tracing_project_id=test_project_1234'],
             ['bin/configmanager', '--logtostderr','--backend', 'http://127.0.0.1',
            ...
            (['--service=test_bookstore.gloud.run',
              ...
              '--service_account_key', '/tmp/service_accout_key'],
             ['bin/configmanager', '--logtostderr', '--backend', 'https://127.0.0.1',
              '--rollout_strategy', 'fixed', '--v', '0',
              '--service', 'test_bookstore.gloud.run',
              '--disable_tracing',
              '--cors_preset', 'basic',
            ...
            (['--backend=https://127.0.0.1:8000', '--enable_backend_routing',
              ...
              '--disable_tracing'],
             ['bin/configmanager',  '--logtostderr','--backend', 'https://127.0.0.1:8000',
              '--rollout_strategy', 'fixed', '--v', '0',
              '--service_json_path', '/tmp/service.json',
              '--disable_tracing',
              '--compute_platform_override', 'Cloud Run(ESPv2)'
