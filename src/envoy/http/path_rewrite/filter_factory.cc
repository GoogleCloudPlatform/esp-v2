...
#include "api/envoy/v12/http/path_rewrite/config.pb.h"
#include "api/envoy/v12/http/path_rewrite/config.pb.validate.h"
...
class FilterFactory
    : public Envoy::Extensions::HttpFilters::Common::FactoryBase<
          ::espv2::api::envoy::v12::http::path_rewrite::FilterConfig,
 ...
 private:
  Envoy::Http::FilterFactoryCb createFilterFactoryFromProtoTyped(
      const ::espv2::api::envoy::v12::http::path_rewrite::FilterConfig&,
