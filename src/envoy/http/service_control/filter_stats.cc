...
void ServiceControlFilterStats::collectQuotaStatus(
  ...
  // https://github.com/protocolbuffers/protobuf/blob/4b4e66743503bf927cfb0f27a267ecd077250667/src/google/protobuf/stubs/status.h#L45
  switch (code) {
    case Code::OK:filter_stats.quota_count_OK_.inc();
      return;
    case Code::CANCELLED:filter_stats.quota_count_CANCELLED_.inc();
      return;
    case Code::UNKNOWN:filter_stats.quota_count_UNKNOWN_.inc();
      return;
    case Code::INVALID_ARGUMENT:filter_stats.quota_count_INVALID_ARGUMENT_.inc();
      return;
    case Code::DEADLINE_EXCEEDED:filter_stats.quota_count_DEADLINE_EXCEEDED_.inc();
      return;
    case Code::NOT_FOUND:filter_stats.quota_count_NOT_FOUND_.inc();
      return;
    case Code::ALREADY_EXISTS:filter_stats.quota_count_ALREADY_EXISTS_.inc();
      return;
    case Code::PERMISSION_DENIED:filter_stats.quota_count_PERMISSION_DENIED_.inc();
      return;
    case Code::RESOURCE_EXHAUSTED:filter_stats.quota_count_RESOURCE_EXHAUSTED_.inc();
      return;
    case Code::FAILED_PRECONDITION:filter_stats.quota_count_FAILED_PRECONDITION_.inc();
      return;
    case Code::ABORTED:filter_stats.quota_count_ABORTED_.inc();
      return;
    case Code::OUT_OF_RANGE:filter_stats.quota_count_OUT_OF_RANGE_.inc();
      return;
    case Code::UNIMPLEMENTED:filter_stats.quota_count_UNIMPLEMENTED_.inc();
      return;
    case Code::INTERNAL:filter_stats.quota_count_INTERNAL_.inc();
      return;
    case Code::UNAVAILABLE:filter_stats.quota_count_UNAVAILABLE_.inc();
      return;
    case Code::DATA_LOSS:filter_stats.quota_count_DATA_LOSS_.inc();
      return;
    case Code::UNAUTHENTICATED:filter_stats.quota_count_UNAUTHENTICATED_.inc();
      return;
    default:return;
  }
}
