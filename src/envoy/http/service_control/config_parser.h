...
class ServiceContext {
 ...
 private:
  const ::espv2::api::envoy::v8::http::service_control::Service& config_;
...
class RequirementContext {
 public:
  RequirementContext(
      const ::espv2::api::envoy::v8::http::service_control::Requirement& config,
 ...
 private:
  const ::espv2::api::envoy::v8::http::service_control::Requirement& config_;
...
class FilterConfigParser {
 public:
  ...
  const ::espv2::api::envoy::v8::http::service_control::FilterConfig& config()
      const {
    return config_;
  }
  ...
  const ::espv2::api::envoy::v8::http::service_control::ApiKeyRequirement&
 ...
 private:
  // The proto config.
  const ::espv2::api::envoy::v8::http::service_control::FilterConfig& config_;
  ...
  ::espv2::api::envoy::v8::http::service_control::Requirement
      non_match_rqm_cfg_;
  ...
  ::espv2::api::envoy::v8::http::service_control::ApiKeyRequirement
      default_api_keys_;
};
