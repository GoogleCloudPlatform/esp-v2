...
#include "api/envoy/v9/http/backend_routing/config.pb.h"
...
class FilterConfig : public Envoy::Logger::Loggable<Envoy::Logger::Id::filter> {
 public:
  FilterConfig(
      const ::espv2::api::envoy::v9::http::backend_routing::FilterConfig&
          proto_config,
  ...
  const ::espv2::api::envoy::v9::http::backend_routing::BackendRoutingRule*
 ...
 private:
  ...
  // The config proto
  ::espv2::api::envoy::v9::http::backend_routing::FilterConfig proto_config_;
  // The stats
  FilterStats stats_;
