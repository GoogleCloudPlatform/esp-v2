...
func (*APIKeyLocation) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _APIKeyLocation_OneofMarshaler, _APIKeyLocation_OneofUnmarshaler, _APIKeyLocation_OneofSizer, []interface{}{
...
func _APIKeyLocation_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	m := msg.(*APIKeyLocation)
	// key
	switch x := m.Key.(type) {
	case *APIKeyLocation_Query:
		b.EncodeVarint(1<<3 | proto.WireBytes)
		b.EncodeStringBytes(x.Query)
	case *APIKeyLocation_Header:
		b.EncodeVarint(2<<3 | proto.WireBytes)
		b.EncodeStringBytes(x.Header)
	case *APIKeyLocation_Cookie:
		b.EncodeVarint(3<<3 | proto.WireBytes)
		b.EncodeStringBytes(x.Cookie)
	case nil:
	default:
		return fmt.Errorf("APIKeyLocation.Key has unexpected type %T", x)
	}
	return nil
}

func _APIKeyLocation_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*APIKeyLocation)
	switch tag {
	case 1: // key.query
...
func _APIKeyLocation_OneofSizer(msg proto.Message) (n int) {
	m := msg.(*APIKeyLocation)
	// key
	switch x := m.Key.(type) {
	case *APIKeyLocation_Query:
