...
func TestBackendRoutingFilter(t *testing.T) {
	testdata := []struct {
        ...
        "typedConfig": {
          ...
          "rules": [
            {
              "operation":"testapi.ESPv2_Autogenerated_CORS_bar",
              "pathPrefix": "/bar",
              "pathTranslation":"APPEND_PATH_TO_ADDRESS"
            },
            {
              "operation":"testapi.ESPv2_Autogenerated_CORS_foo",
              "pathPrefix": "/foo",
              "pathTranslation":"CONSTANT_ADDRESS"
            },
            {
...
`,
        ...
        "typedConfig":{
          ...
          "rules":[
            {
            	"jwtAudience": "bar.com",
            	"operation": "get_testapi.ESPv2_Autogenerated_CORS_bar"
            },
            {
            	"jwtAudience": "foo.com",
            	"operation":"get_testapi.ESPv2_Autogenerated_CORS_foo"
            },
            {
              "jwtAudience": "bar.com",
			...
			wantPathMatcherFilter: `
{
   ...
   "typedConfig":{
      ...
      "rules":[
         ...
         {
            "operation":"endpoints.examples.bookstore.Bookstore.ESPv2_Autogenerated_HealthCheck",
            "pattern":{
               "httpMethod":"GET",
               "uriTemplate":"/healthz"
            }
   ...
   "typedConfig":{
      ...
      "rules":[
         {
            "operation":"1.echo_api_endpoints_cloudesf_testing_cloud_goog.ESPv2_Autogenerated_HealthCheck",
            "pattern":{
               "httpMethod":"GET",
               "uriTemplate":"/"
            }
