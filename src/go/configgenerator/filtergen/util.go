...
func MethodToCORSSelector(api *apipb.Api, method *apipb.Method, opts options.ConfigGeneratorOptions) string {
	return api.GetName() + opts.CorsOperationDelimiter + method.GetName()
}
