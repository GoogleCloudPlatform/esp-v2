...
// SetCorsOperationDelimiter is a helper function to set corsOperationDelimiter
func SetCorsOperationDelimiter(opts options.ConfigGeneratorOptions) {
	corsOperationDelimiter =  fmt.Sprintf(".%s_CORS_", opts.HealthCheckAutogeneratedOperationPrefix)
}
