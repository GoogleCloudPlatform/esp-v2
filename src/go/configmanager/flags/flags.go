...
var (
  ...
  omitted, the proxy contacts the metadata service to fetch an access token`)
	SaGenTokenPort = flag.Uint("sa_gen_token_port", 8791, "Port that envoy use to fetch access token generated by service account credential, for accessing servicecontrol.")
