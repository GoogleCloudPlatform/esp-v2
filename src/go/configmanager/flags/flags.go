...
var (
    ...
    HealthCheckAutogeneratedOperationPrefix = flag.String("health_check_autogenerated_operation_prefix", default.HealthCheckAutogeneratedOperationPrefix, `Specify the health check autogenerated operation prefix.`)
