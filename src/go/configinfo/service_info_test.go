	...
	testData := []struct {
	...
	}{
		{
			...
			wantMethods: map[string]*methodInfo{
				...
				fmt.Sprintf("%s.%s", testApiName, "ESPv2_Autogenerated_HealthCheck"): &methodInfo{
		...
		},
		{
			...
			wantMethods: map[string]*methodInfo{
				...
				"1.echo_api_endpoints_cloudesf_testing_cloud_goog.ESPv2_Autogenerated_HealthCheck": &methodInfo{
					ShortName:          "ESPv2_Autogenerated_HealthCheck",
					ApiName:            "1.echo_api_endpoints_cloudesf_testing_cloud_goog",
					SkipServiceControl: true,
					IsGenerated:        true,
