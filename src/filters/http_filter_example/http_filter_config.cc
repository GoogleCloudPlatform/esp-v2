...
#include "src/filters/http_filter_example/http_filter.pb.h"
#include "src/filters/http_filter_example/http_filter.pb.validate.h"
...
class HttpSampleDecoderFilterConfig : public NamedHttpFilterConfigFactory {
 ...
 private:
  Http::FilterFactoryCb createFilter(const sample::Decoder& proto_config,
                                     FactoryContext&) {
