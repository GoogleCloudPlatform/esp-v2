...
diff bazel-bin/api/envoy/http/common/*/base_proto_go_proto%/cloudesf.googlesource.com/gcpproxy/src/go/proto/api/envoy/http/common src/go/proto/api/envoy/http/common
